...
<%!
  // 배열을 인자로 받아 하나의 문자열로 변환하는 함수
  public String makeStrimg(String[] ar, String delim){
...
%>
  ...
  <%
    ...
    String phone = makeStrimg(u_phone, "-");
