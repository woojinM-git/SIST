...
<article id="wrap">
    ...
    <div id="contents">
        <div class="main_img">
            <a href="">
                <img src="resources/img/@img00.png" alt="메인공고이미지"/>
            </a>
        </div>
        <div class="main_news">
            ...
            <span class="thum_img">
              ...
              <span id="btn_play" title="동영상 재생">
                <a href="https://www.youtube.com/?app=desktop&hl=ko&gl=KR"></a>
              </span>
            </span>
                    <span class="subject ellip">
              생수 1리터의 생명을 선물해 주세요
        ...
        <div class="main_board">
            ...
            <span class="thum_img">
              <img src="resources/img/@img04.png" alt="기사이미지"/>
                    ...
                    <span class="src">
              [캠페인] 뜨거웠던 여름이 빨리지나가고 시원한 바람과 오색의 단풍들이 사색의 시간을 만들어주는 계절에
            </span>
                </article>
            </div>
            <!--- 트위터 끝 --->
